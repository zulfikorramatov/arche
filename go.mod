module github.com/zulfikorramatov/arche
...
require (
	...
	github.com/githubzhaoqian/go-redis-prefix/v9 v9.11.2
	...
	go.elastic.co/apm/module/apmpgxv5/v2 v2.7.12
	go.elastic.co/apm/module/apmslog/v2 v2.7.12
